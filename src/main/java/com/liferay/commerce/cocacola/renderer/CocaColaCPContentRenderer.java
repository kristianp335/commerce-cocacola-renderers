...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.renderer.key=" + CocaColaCPContentRenderer.KEY,
...
public class CocaColaCPContentRenderer implements CPContentRenderer {

	public static final String KEY = "CocaCola Product Detail";
	...
	public String getLabel(Locale locale) {
		return "Coca Cola Product Detail Renderer";
	}
