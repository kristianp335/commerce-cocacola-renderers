...
String metakey = cpCatalogEntry.getMetaKeywords("en_US");
System.out.println(metakey);
String buyingWindow = "";
if(metakey.contains("window")) {
	buyingWindow = "System wide total unit orders: (552) -  Buying Window closes (02/28/2019)";
}
				...
				<div class="autofit-float autofit-row product-detail-info-header">
					<div class="autofit-col autofit-col-expand">
						<div class="autofit-float autofit-row product-detail-price">
							<h3 class="availability commerce-price w-100" style="color: green; text-align: left;"><%= cpContentHelper.getAvailabilityLabel(request) %></h3>	
							<h3 class="stockQuantity commerce-price w-100" style="text-align: left;"><%= cpContentHelper.getStockQuantityLabel(request) %></h3>
							...
							<h4 class="stockQuantity commerce-price w-100" style="color: grey; text-align: left;"><%= buyingWindow %></h4>
